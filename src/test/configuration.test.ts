...
//   it("getClassesMap respects config", () => {
//     createConfigStub({
//       categories: {
...
//   it("don't sort on command if language is not supported", async () => {
...
//   it("sort on command if language is supported", async () => {
//     const showWarningMessageStub = sinon.stub(
//       vscode.window,
//       "showWarningMessage"
//     );
...
//   it("when file is saved, tailwind is not sorted if sortOnSave is false", async () => {
...
//   it("when file is saved, tailwind is sorted if sortOnSave is true", async () => {
